...
<body id="page-top" >
              ...
              <div class="card shadow mb-4">
                ...
                <div class="card-body">
                  ...
                  <form action="<?=BASEURL;?>helper/routing.php" method="POST" id="edit-customer">
                      ...
                      <button type="submit" class="btn btn-primary" name="edit_customer" value="editCustomer"><i class="fa fa-check"></i> Submit</button>
                    </form>
  ...
  <!--PAGE LEVEL SCRIPTS-->
  <?php require_once(__DIR__ . "/../includes/page-level/customer/edit-customer-scripts.php");?>
</body>
