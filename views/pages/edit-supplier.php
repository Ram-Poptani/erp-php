...
$pageTitle = "Quick ERP | Edit Supplier";
...
<form action="<?=BASEURL;?>helper/routing.php" method="POST" id="edit-supplier">
                      ...
                      <div class="form-row">
                        ...
                        <div class="form-group col-md-6">
                          ...
                          <input  type="text" 
                                  name="company_name" 
                                  id="company_name" 
                                  class="form-control <?= $errors!='' && $errors->has('company_name') ? 'error' : '';?>"
                                  placeholder = "Enter Email"
                                  value="<?=$old != '' && isset($old['company_name']) ?$old['company_name']: '';?>"/>
                          <?php
                      ...
                      <button type="submit" class="btn btn-primary" name="edit_supplier" value="editSupplier"><i class="fa fa-check"></i> Submit</button>
</form>
  ...
  <!--PAGE LEVEL SCRIPTS-->
  <?php require_once(__DIR__ . "/../includes/page-level/supplier/edit-supplier-scripts.php");?>
</body>
